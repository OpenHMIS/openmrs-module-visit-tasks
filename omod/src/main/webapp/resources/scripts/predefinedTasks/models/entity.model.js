...
(function() {
    ...
    /* Define model fields */
    function PredefinedTasksModel(GenericMetadataModel) {
    ...
    baseModel.factory("PredefinedTasksModel", PredefinedTasksModel);

    PredefinedTasksModel.$inject = ['GenericMetadataModel'];
